"""
Django settings for ThInitPack project.
...
SECRET_KEY = 'pgis)l+83jg$axp5=dwxa04s705t)u3$$-(p8eq6t2_oqxl%49'
...
WSGI_APPLICATION = 'ThInitPack.wsgi.application'
